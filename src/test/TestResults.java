...
/**
 * Class for storing test results consisting of arrays of doubles.
 * Each array of doubles is referenced by a String label.
 * A TestResults object may be given a type name to describe what it represents.
 * The TestResults class extends HashMap, so all HashMap methods may be used.
 * Result labels and arrays correspond to the keys and values in the HashMap.
 * 
...
public class TestResults extends HashMap<String, double[]> {
	 ...
	 * @param result The data series, should be an array of length 2 containing the arrays for each dimension of the data series, in order of first and second dimension.
	 */
	 ...
	 * @param result The data series, should be an array of length 3 containing the arrays for each dimension of the data series, in order of first, second and third dimension
	 */

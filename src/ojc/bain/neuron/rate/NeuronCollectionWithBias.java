...
/**
 * A base for (typically rate-based encoding type) neurons that include a bias in the activation.
 * Sub-classes must add the {@link #bias} to the relevant calculations, for example with
 * <code>neuronInputs[neuronID] += bias[neuronID];</code> in the {@link #run()} method.
 * 

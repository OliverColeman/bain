...
public class NeuronRandomConfig extends ComponentConfiguration {
	...
	/**
	 * Create a NeuronRandom with the given firing rate. The rate describes how likely the Neuron is to spike every second: a
	 * value of 0 would cause the Neuron to never spike, a value of 1 would cause the Neuron to spike once per second on
	 * average.
	 * 
